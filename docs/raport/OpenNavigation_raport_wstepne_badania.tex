...
Skrypty wykonujące analizę najoptymalniejszej trasy na podstawie danych znajdują się pod następującymi ścieżkami:
\begin{itemize}
...
a raczej do planowania trasy z uwzględnieniem danych historycznych i kontekstowych.
